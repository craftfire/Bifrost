...
public interface ScriptInterface {
	...
	/**
	 * Returns true if {@param username} and {@param password} matches the username and password for the user in the script.
	 *
	 ...
	 *
	 * @param username The username of the user to hash.
