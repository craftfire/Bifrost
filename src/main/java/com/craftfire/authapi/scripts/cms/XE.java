...
public class XE extends Script {
    private final String scriptName = "xpressengine";
    private final String shortName = "xe";
    ...
    public XE(ScriptAPI.Scripts script, String version, DataManager dataManager) {
