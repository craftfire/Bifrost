...
public class VBulletin extends Script {
    private final String scriptName = "vbulletin";
    private final String shortName = "vb";
    ...
    public VBulletin(ScriptAPI.Scripts script, String version, DataManager dataManager) {
